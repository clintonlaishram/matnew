...
const AllProductMediaPage = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState<string>('Grocery'); // Default category is "Grocery"
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter products by default category "Grocery"
        filterProducts(searchTerm, 'Grocery');
      } catch (err) {
      ...
      <div className={styles.categoryFilter}>
        ...
        <div className={styles.categoryButtons}>
          <button
            ...
            style={{
              backgroundColor: selectedCategory === 'All' ? '#FFD700' : '#f0f0f0', // Highlight selected category
            }}
          >
            All
          </button>
          {categories.map((category, index) => (
            <button
              ...
              style={{
                backgroundColor: category === selectedCategory ? '#FFD700' : '#f0f0f0', // Highlight selected category
              }}
            >
              {category}
            </button>
